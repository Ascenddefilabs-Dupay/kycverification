...
class KYCDetail(models.Model):
    ...
    adhar_front_image = models.FileField(upload_to='Dupay_Files',blank=True, null=True)
    adhar_back_image = models.FileField(upload_to='Dupay_Files',blank=True, null=True)

    pan_number = models.CharField(max_length=10, blank=True, null=True)
    pan_front_image = models.FileField(upload_to='Dupay_Files',blank=True, null=True)
    pan_back_image = models.FileField(upload_to='Dupay_Files',blank=True, null=True)
